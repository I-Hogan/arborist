...
`templates/docs`, `templates/experiments`, and `templates/scripts`.
...
files/directories from `templates/arborist`, `templates/docs`,
`templates/experiments`, and `templates/scripts` without overwriting existing files.
