...
const makeTempDir = async () => fs.mkdtemp(path.join(os.tmpdir(), "arborist-list-cleanup-"));

const writeList = (dir, name, body) => fs.writeFile(path.join(dir, name), body, "utf8");

const readList = (dir, name) => fs.readFile(path.join(dir, name), "utf8");
